# Überblick über die Compliance as a Service Features von fiskaltrust

## Basis (Security) Features

- [Queue-Abstraktion.md](Queue-Abstraktion.md) 
- [SCU-Abstraktion.md](SCU-Abstraktion.md) 

## Data Storage

- [SQLite-Storage.md](SQLite-Storage.md) 
- [EF-Storage.md](EF-Storage.md) 

- [Azure-table-Storage.md](Azure-table-Storage.md) 

## Daten Export

- [daily-closing-dsfinv-k-Export.md](daily-closing-dsfinv-k-Export.md) 
- [TAR-file-TSE-Unload.md](TAR-file-TSE-Unload.md) 
